...
$(function () {
    ...
    usuario = function () {
        ...
        function _initializeScreen() {
            ...
            objUsuarios.RestoreUserImage($($_usuario.field.imagemUpload)[0], $($_usuario.field.imagem)[0]);
            //document.getElementById('img-upload').src = document.getElementById('Imagem').value;
        }
